...
In this step, we will generate output files formatted for downstream analysis
in *phyloseq*.
...
Build the final *phyloseq* object. Notes:

  - While we will not add phylogenetic tree now,
