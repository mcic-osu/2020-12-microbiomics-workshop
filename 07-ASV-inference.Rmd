...
- Fill out the form as shown [here](03-OSC-slides.html#rstudio_server_job)
...
- In the R console, enter:
  ...
  ```sh
  setwd('/fs/project/PAS0471/workshops/2020-12_micro')
  ```

- Then in the Files pane, in the bottom right, click the Gear icon and
  then `Go To Working Directory`, as shown below:
  
<p align="center">
<img src=img/RStudio_go-to-wd.png width="500">
</p>
