...
- This assumes you still have an active RStudio Server job at OSC;
   if not see the
   [instructions on the previous page](06-reads-to-ASV.html#start-an-rstudio-server-job-at-osc) to start one.
...
indir <- 'analysis/ASV_inference/output/'

# Dir for output:
outdir_base <- 'analysis/ASV_analysis/output/'
