...
```{bash}
indir=raw_data/fastq_subsample/
outdir_base=processed_data/fastq_trimmed
...
# ## Output dir - first trim:   processed_data/fastq_trimmed/first_trim
# ## Input dir - second trim:   processed_data/fastq_trimmed/first_trim
# 
# ## Looping through input files...
# 
# ## R1 input file:
# -r--r--r-- 1 jelmer PAS0471 7.4M Dec  9 08:27 raw_data/fastq/201-S4-V4-V5_S53_L001_R1_001.fastq.gz
# ## R2 input file:
# -r--r--r-- 1 jelmer PAS0471 8.8M Dec  9 08:27 raw_data/fastq/201-S4-V4-V5_S53_L001_R2_001.fastq.gz
# 
# 
# ## Running cutadapt for the first trim:
# This is cutadapt 3.1 with Python 3.8.6
# Command line parameters: -g GAGTGYCAGCMGCCGCGGTAA -G ACGGACTACNVGGGTWTCTAAT --discard-untrimmed --pair-filter=any -o /processed_data/fastq_trimmed/first_trim/201-S4-V4-V5_S53_L001_R1_001.fastq.gz -p /processed_data/fastq_trimmed/first_trim/201-S4-V4-V5_S53_L001_R2_001.fastq.gz raw_data/fastq/201-S4-V4-V5_S53_L001_R1_001.fastq.gz raw_data/fastq/201-S4-V4-V5_S53_L001_R2_001.fastq.gz
...
```{bash}
ls -lh processed_data/fastq_trimmed/second_trim/
