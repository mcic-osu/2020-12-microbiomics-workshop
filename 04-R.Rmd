...
if there were many, it would keep count of them.)
...
```{r read_csv_from_web, eval=FALSE}
...
This shows that there are 34,786 rows and 13 columns,
and then for each column, it gives information about the data
