...
&nbsp; &nbsp;  &nbsp; instructions to the *SLURM* scheduler to reserve X nodes/cores/time, etc.
]
...
- To start an [interactive job](https://www.osc.edu/supercomputing/knowledge-base/slurm_migration/how_to_monitor_and_manage_jobs):

  ```sh
  sinteractive            # Default: 30-mins, 1-core, 1-node
  
  sinteractive -time=120  # Two hours 
  ```
