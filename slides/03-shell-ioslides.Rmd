...
#download.file("https://asciinema.org/a/LqUiTAvXtL7XTnzgSivDt0djV",
#              destfile = tf,
#              mode = "wb")

library(asciicast)
asciinema_player(
  read_cast("https://asciinema.org/a/LqUiTAvXtL7XTnzgSivDt0djV.cast?dl=1"),
  rows = 45
  )

#<script id="asciicast-LqUiTAvXtL7XTnzgSivDt0djV" src="https://asciinema.org/a/LqUiTAvXtL7XTnzgSivDt0djV.js" async></script>
```
